...
class AutoWebPlugin {
     ...
     *
     * options.onPagesResolved {function}
     *      call when all pages has been resolved with all resolved pages's info
     */
    constructor(pageDir, options) {
        options = Object.assign({}, options);
        this.options = options;
        const { template, entity, filename, ignorePages, onPagesResolved } = options;
        ...
        if (typeof onPagesResolved === 'function') {
            onPagesResolved(Object.assign({}, this.entityMap));
        }
    }
